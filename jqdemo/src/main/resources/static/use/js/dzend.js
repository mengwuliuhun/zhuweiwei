$(function () {
    ...
    $.getJSON("../tryItemVo_ajax", {category: "大众试用",type:"end"}, function (data) {
        var self=$(".comMore");
        ...
        list.forEach(function (s) {
            $("#dl").append("<dt>\n" +
                "                <a href=\"detail.html\">\n" +
                "                    <span class=\"top-tip tys\">首发</span>\n" +
    ...
    $(".comMore").click(function () {
        ...
        var self = $(this);
        self.addClass("loading").html("正在加载中");
        $.getJSON("../tryItemVo_ajax", {category: "大众试用",type:"end",pno:pno,psize:psize}, function (data) {
            var ret = data.data;
            allLen = ret.navigateLastPage;//获取json长度
            var list = ret.list;
            list.forEach(function (s) {
